<body>
       <div class="section no-pad-bot cork-color">
        <div class="container">
          <h1 class="header center white-text" style="font-weight:bold;">App title</h1>
          <div class='row center'>
            <h4 class ="header col s12 light center white-text">
...
"There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain..."
          ...
          <div class="row center"><a class="white-text" href="https://github.com/Dogfalo/materialize">beta release v0.98.2</a></div>
        ...
        <div class="github-commit">
          <div class="container">
            <div class="commit">
              ...
              <a id="github-button" href="https://github.com/classprep/cork-server" target="_blank" class="btn-flat right grey-text text-lighten-5 waves-effect waves-light hide-on-small-only">Github</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col l4 s12">
            ...
            <a class="btn waves-effect waves-light cork-color lighten-3" target="_blank" href="https://gitter.im/classprep/CORK">Chat</a>
          </div>
